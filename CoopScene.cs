...
{
    /// <summary>
    /// Co-op: replicate the MISSION / SCENE TRANSITION so both players are
    /// co-located. Sim-gating + entity sync assume both are already in the same MissionActive scene —
